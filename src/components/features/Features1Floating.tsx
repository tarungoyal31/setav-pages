...
const Chip = styled(MuiChip, {
    ...
    variants: [
        {
            props: (props: ChipProps) => !!props.selected,
            style: {
                background:
                        `linear-gradient(to bottom right, ${theme.palette.primary.main}, ${theme.palette.primary.main})`,
                color: 'hsl(0, 0%, 100%)',
                ...
                //     color: (theme.vars || theme).palette.primary.contrastText,
                // },
                // textColor: (theme.vars || theme).palette.primary.contrastText,
            },
        },
    ],
}));
